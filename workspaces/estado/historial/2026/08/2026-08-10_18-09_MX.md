...
**Generado:** 2026-08-11 00:09 UTC (18:09 UTC-6)
...
| Hora de la medición | 2026-08-11 00:08 UTC | |
...
| **97%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Tlaxcala Acuífero** (19.3, -98.2) · nodo 118 | 31 | ~8 días |
| **93%** `▓▓▓▓▓` | SISMO_M4 | **Kamchatka** (53.0, 159.0) · nodo 20 | 88 | ~8 días |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,218
...
| Asertividad viva | 15.3% | 15.4% | -0.1% |
| Aciertos / Fallos (vivos) | 584 / 3,218 | 584 / 3,193 | +0 aciertos |
| Pendientes de auditoría | 433 | 433 | +0 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 15% → 16% → 16% → 16% → 15%*
...
| **Total predicciones** | 871897 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179168/182386 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 4,252 · Sentinel Omega · Fractal Core Research*
