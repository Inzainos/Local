...
**Generado:** 2026-08-14 04:02 UTC (22:02 UTC-6)
...
| Hora de la medición | 2026-08-14 03:57 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 8.0, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.0 | 9.2 | 8.9 | 20.9 | P44 |
| Muro de los 5 | 3 | 2.7 | 2.3 | 4 | P100 |
| Silent Trigger | activo | 60% ciclos | 71% ciclos | — | — |
| Asertividad viva | 21% | 56% | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 4269 |
| Ventanas con evento real (tasa base) | 85% |
| Asertividad del sistema | 21% |
...
| **89%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 260 | ~8 días |
...
| alfa2 | _en vivo · 435 ciclos · 78164 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 20.6% |
| **Últimos 7 días** (viva) | 56.4% |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,354
- FALSO POSITIVO — avisó y no pasó nada: 35
- PENDIENTE — ventana de 72h aún abierta: 883
...
| Asertividad viva | 20.6% | 20.7% | -0.1% |
| Aciertos / Fallos (vivos) | 880 / 3,354 | 879 / 3,330 | +1 aciertos |
| Pendientes de auditoría | 883 | 887 | -4 |
...
| **Total predicciones** | 872355 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179464/182818 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 5,160 · Sentinel Omega · Fractal Core Research*
