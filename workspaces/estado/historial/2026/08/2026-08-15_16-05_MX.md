...
**Generado:** 2026-08-15 22:05 UTC (16:05 UTC-6)
...
| Hora de la medición | 2026-08-15 22:03 UTC | |
...
| **89%** `▓▓▓▓░` | SISMO_M4 | **Tabasco Delta** (18.0, -93.0) · nodo 49 | 118 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M4 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 17 | ~8 días |
...
| alfa2 | _en vivo · 476 ciclos · 85403 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,835
...
| Asertividad viva | 18.8% | 18.9% | -0.1% |
| Aciertos / Fallos (vivos) | 898 / 3,835 | 898 / 3,814 | +0 aciertos |
| Pendientes de auditoría | 830 | 826 | +4 |
...
| **Total predicciones** | 872854 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179482/183317 | 98% `▓▓▓▓▓▓▓▓` | 0.97 |
...
*Ciclos totales: 5,606 · Sentinel Omega · Fractal Core Research*
