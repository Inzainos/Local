...
**Generado:** 2026-08-05 16:05 UTC (10:05 UTC-6)
...
| Hora de la medición | 2026-08-05 16:02 UTC | |
...
| alfa2 | _en vivo · 269 ciclos · 48524 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,284
...
| Aciertos / Fallos (vivos) | 239 / 2,284 | 239 / 2,262 | +0 aciertos |
| Pendientes de auditoría | 640 | 637 | +3 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 9% → 10% → 10% → 10% → 10%*
...
| **Total predicciones** | 870609 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178823/181107 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
*Ciclos totales: 3,171 · Sentinel Omega · Fractal Core Research*
