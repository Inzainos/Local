...
**Generado:** 2026-08-11 02:11 UTC (20:11 UTC-6)
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.1 | 8.6 | 8.7 | 20.9 | P85 |
...
| **86%** `▓▓▓▓░` | SISMO_M4 | **Kamchatka** (53.0, 159.0) · nodo 20 | 88 | ~8 días |
...
| alfa2 | _en vivo · 362 ciclos · 64572 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| Aciertos / Fallos (vivos) | 586 / 3,241 | 586 / 3,241 | +0 aciertos |
| Pendientes de auditoría | 432 | 409 | +23 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 16% → 16% → 15% → 15% → 15%*
...
*Ciclos totales: 4,276 · Sentinel Omega · Fractal Core Research*
