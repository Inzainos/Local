...
**Generado:** 2026-08-02 14:13 UTC (08:13 UTC-6)
...
| Hora de la medición | 2026-08-02 14:08 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.2 | 7.7 | 8.7 | 16.8 | P10 |
| Muro de los 5 | 2 | 2.0 | 2.2 | 4 | P84 |
| Silent Trigger | inactivo | 78% ciclos | 77% ciclos | — | — |
...
| alfa2 | _en vivo · 214 ciclos · 38913 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 154
- FALLO — el evento ocurrió sin aviso (lo más castigado): 1,484
...
| Aciertos / Fallos (vivos) | 154 / 1,484 | 153 / 1,461 | +1 aciertos |
| Pendientes de auditoría | 887 | 887 | +0 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 10% → 10% → 10% → 10% → 9%*
...
| **Total predicciones** | 869724 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178738/180222 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
_... y 868230 aciertos más en los últimos 30 días_
...
*Ciclos totales: 2,534 · Sentinel Omega · Fractal Core Research*
