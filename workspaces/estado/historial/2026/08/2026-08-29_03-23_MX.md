...
**Generado:** 2026-08-29 09:23 UTC (03:23 UTC-6)
...
| Precursores detectados | 2 | ["NIEBLA_TULE", "SEISMIC_CLUSTER"] |
| Hora de la medición | 2026-08-29 09:20 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 16.0, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 16.0 | 8.3 | 8.5 | 20.9 | P99 |
| Muro de los 5 | 2 | 2.0 | 2.2 | 4 | P75 |
| Silent Trigger | inactivo | 80% ciclos | 74% ciclos | — | — |
| Asertividad viva | 22% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 5710 |
| Ventanas con evento real (tasa base) | 83% |
| Asertividad del sistema | 22% |
| **Ganancia** (sistema ÷ tasa base) | 0.26× |
...
| padre | 4,330 | 179,235 | 0.30 `▓░░░░░` |
| alfa2 | _en vivo · 635 ciclos · 114895 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 97.1% |
| **Viva** (operación real, auditada) | 21.9% |
| **Últimos 7 días** (viva) | — |
...
- ACIERTO — avisó y el evento ocurrió: 1,252
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,398
- FALSO POSITIVO — avisó y no pasó nada: 60
- PENDIENTE — ventana de 72h aún abierta: 23,560
...
| Asertividad viva | 21.9% | 21.9% | +0.0% |
| Aciertos / Fallos (vivos) | 1,252 / 4,398 | 1,252 / 4,398 | +0 aciertos |
| Pendientes de auditoría | 23,560 | 23,560 | +0 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 19% → 19% → 19% → 22% → 22%*
...
| **Fallos** | 2946 |
| **Falsos positivos** | 60 |
| **Tasa de acierto** | 26.8% `▓▓▓░░░░░░░░░` |
| **Total predicciones** | 4105 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Total | Tasa | Confianza |
|-----|----------|-------|------|-----------|
| padre | 1099 | 4105 | 26.8% `▓▓░░░░░░` | 0.04 |

### 🎯 Predicciones y Aciertos Recientes

| Fecha | Bot | Señal | Nodo / Zona | Verdad Auditada (USGS) | Fase |
|-------|-----|-------|-------------|-------------------------|------|
| 2026-08-16 04:16 | `padre` | **WATCH** | Baja California Sur | 4 eventos en ventana de 72h (máx M5.7, nodos de la predicción) | viva |
| 2026-08-16 03:07 | `padre` | **WATCH** | Baja California Sur | 4 eventos en ventana de 72h (máx M5.7, nodos de la predicción) | viva |
| 2026-08-16 02:06 | `padre` | **WATCH** | Baja California Sur | 2 eventos en ventana de 72h (máx M5.6, nodos de la predicción) | viva |
| 2026-08-16 01:52 | `padre` | **WATCH** | Baja California Sur | 4 eventos en ventana de 72h (máx M5.7, nodos de la predicción) | viva |
| 2026-08-16 01:47 | `padre` | **WATCH** | Baja California Sur | 4 eventos en ventana de 72h (máx M5.7, nodos de la predicción) | viva |
| 2026-08-16 01:41 | `padre` | **WATCH** | Baja California Sur | 2 eventos en ventana de 72h (máx M5.6, nodos de la predicción) | viva |
| 2026-08-16 00:52 | `padre` | **WATCH** | Baja California Sur | 4 eventos en ventana de 72h (máx M5.7, nodos de la predicción) | viva |
| 2026-08-15 23:56 | `padre` | **WATCH** | Baja California Sur | 2 eventos en ventana de 72h (máx M5.6, nodos de la predicción) | viva |
| 2026-08-15 23:32 | `padre` | **WATCH** | Baja California Sur | 2 eventos en ventana de 72h (máx M5.6, nodos de la predicción) | viva |
| 2026-08-15 21:53 | `padre` | **WATCH** | Baja California Sur | 4 eventos en ventana de 72h (máx M5.7, nodos de la predicción) | viva |

_... y 1089 aciertos más en los últimos 30 días_
...
*Ciclos totales: 8,684 · Sentinel Omega · Fractal Core Research*
