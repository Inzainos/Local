...
**Generado:** 2026-08-15 07:42 UTC (01:42 UTC-6)
...
| Hora de la medición | 2026-08-15 07:41 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 9.7, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.7 | 10.3 | 9.0 | 20.9 | P66 |
| Muro de los 5 | 3 | 2.8 | 2.3 | 4 | P100 |
| Silent Trigger | activo | 52% ciclos | 69% ciclos | — | — |
| Asertividad viva | 19% | 33% | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 4604 |
| Ventanas con evento real (tasa base) | 86% |
| Asertividad del sistema | 19% |
| **Ganancia** (sistema ÷ tasa base) | 0.23× |
...
| alfa2 | _en vivo · 461 ciclos · 82508 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 19.5% |
| **Últimos 7 días** (viva) | 32.7% |
...
- ACIERTO — avisó y el evento ocurrió: 896
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,673
- FALSO POSITIVO — avisó y no pasó nada: 35
- PENDIENTE — ventana de 72h aún abierta: 822
...
| Asertividad viva | 19.5% | 19.5% | -0.1% |
| Aciertos / Fallos (vivos) | 896 / 3,673 | 895 / 3,652 | +1 aciertos |
| Pendientes de auditoría | 822 | 825 | -3 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 20% → 20% → 20% → 20% → 20%*
...
| **Total predicciones** | 872690 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179480/183153 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
- **Predicción hecha:** 2026-08-11 17:58 UTC
- **Resuelto:** 2026-08-14 18:04:08 UTC
- **Qué pasó:** 4 eventos en ventana de 72h (máx M5.5, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-11 17:48 UTC
- **Resuelto:** 2026-08-14 18:04:08 UTC
- **Qué pasó:** 4 eventos en ventana de 72h (máx M5.5, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva

_... y 868972 aciertos más en los últimos 30 días_
...
*Ciclos totales: 5,434 · Sentinel Omega · Fractal Core Research*
