...
**Generado:** 2026-08-06 04:10 UTC (22:10 UTC-6)
...
| Precursores detectados | 4 | ["NIEBLA_TULE", "SILENT_TRIGGER", "SEISMIC_CLUSTER", "SCHUMANN"] |
| Hora de la medición | 2026-08-06 04:07 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 7.6, muro 3/5 (breach) y firma máxima 100%.
...
| **93%** `▓▓▓▓▓` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 603 | ~8 días |
...
| alfa2 | _en vivo · 281 ciclos · 50686 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,416
...
| Aciertos / Fallos (vivos) | 251 / 2,416 | 251 / 2,391 | +0 aciertos |
...
| **Total predicciones** | 870753 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178835/181251 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
*Ciclos totales: 3,316 · Sentinel Omega · Fractal Core Research*
