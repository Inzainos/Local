...
**Generado:** 2026-08-31 16:16 UTC (10:16 UTC-6)
...
| Hora de la medición | 2026-08-31 16:15 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.1, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.1 | 9.2 | 9.1 | 20.9 | P70 |
...
| alfa2 | _en vivo · 690 ciclos · 125021 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
*Asertividad viva, últimos cortes: 19% → 22% → 22% → 22% → 80%*
...
| **Total predicciones** | 27006 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Total | Tasa | Confianza |
|-----|----------|-------|------|-----------|
| padre | 3780 | 6391 | 59.1% `▓▓▓▓▓░░░` | 0.05 |
...
_... y 23210 aciertos más en los últimos 30 días_
...
*Ciclos totales: 9,958 · Sentinel Omega · Fractal Core Research*
