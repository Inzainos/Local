...
**Generado:** 2026-08-12 06:28 UTC (00:28 UTC-6)
...
| Hora de la medición | 2026-08-12 06:28 UTC | |
...
| Silent Trigger | activo | 73% ciclos | 72% ciclos | — | — |
...
| **93%** `▓▓▓▓▓` | SISMO_M4 | **Kamchatka** (53.0, 159.0) · nodo 20 | 91 | ~8 días |
...
- PENDIENTE — ventana de 72h aún abierta: 460
...
| Pendientes de auditoría | 460 | 456 | +4 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 20% → 20% → 21% → 21% → 21%*
...
*Ciclos totales: 4,616 · Sentinel Omega · Fractal Core Research*
