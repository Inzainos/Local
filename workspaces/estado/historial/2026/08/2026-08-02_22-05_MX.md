...
**Generado:** 2026-08-03 04:05 UTC (22:05 UTC-6)
...
| Hora de la medición | 2026-08-03 04:03 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.5, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.5 | 7.7 | 8.8 | 16.8 | P91 |
| Muro de los 5 | 2 | 2.0 | 2.2 | 4 | P85 |
| Silent Trigger | inactivo | 72% ciclos | 72% ciclos | — | — |
...
| **93%** `▓▓▓▓▓` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 373 | ~8 días |
...
| alfa2 | _en vivo · 228 ciclos · 41461 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 1,636
...
| Aciertos / Fallos (vivos) | 169 / 1,636 | 169 / 1,614 | +0 aciertos |
| Pendientes de auditoría | 886 | 883 | +3 |
...
| **Total predicciones** | 869891 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178753/180389 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
*Ciclos totales: 2,699 · Sentinel Omega · Fractal Core Research*
