...
**Generado:** 2026-08-13 22:02 UTC (16:02 UTC-6)
...
| Hora de la medición | 2026-08-13 21:58 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.1 | 9.2 | 8.9 | 20.9 | P46 |
| Muro de los 5 | 3 | 2.6 | 2.3 | 4 | P100 |
| Silent Trigger | inactivo | 64% ciclos | 71% ciclos | — | — |
...
| **94%** `▓▓▓▓▓` | SISMO_M4 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 82 | ~8 días |
...
| alfa2 | _en vivo · 429 ciclos · 77036 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 20.8% |
...
- ACIERTO — avisó y el evento ocurrió: 873
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,289
...
| Asertividad viva | 20.8% | 20.9% | -0.1% |
| Aciertos / Fallos (vivos) | 873 / 3,289 | 873 / 3,264 | +0 aciertos |
...
| **Total predicciones** | 872283 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179457/182746 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
_... y 868949 aciertos más en los últimos 30 días_
...
*Ciclos totales: 5,088 · Sentinel Omega · Fractal Core Research*
