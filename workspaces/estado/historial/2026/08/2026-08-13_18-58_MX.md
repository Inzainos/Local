...
**Generado:** 2026-08-14 00:58 UTC (18:58 UTC-6)
...
| Hora de la medición | 2026-08-14 00:57 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.1 | 9.2 | 8.9 | 20.9 | P45 |
| Muro de los 5 | 3 | 2.6 | 2.3 | 4 | P100 |
| Silent Trigger | inactivo | 62% ciclos | 71% ciclos | — | — |
| Asertividad viva | 21% | 61% | — | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 260 | ~8 días |
...
| alfa2 | _en vivo · 432 ciclos · 77600 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 20.7% |
| **Últimos 7 días** (viva) | 60.7% |
...
- ACIERTO — avisó y el evento ocurrió: 879
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,330
...
| Asertividad viva | 20.7% | 20.7% | -0.0% |
| Aciertos / Fallos (vivos) | 879 / 3,330 | 874 / 3,309 | +5 aciertos |
| Pendientes de auditoría | 872 | 888 | -16 |
...
| **Total predicciones** | 872330 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179463/182793 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
- **Predicción hecha:** 2026-08-09 02:02 UTC
- **Resuelto:** 2026-08-12 04:05:43 UTC
- **Qué pasó:** sin eventos en ventana de 72h (nodos de la predicción)
- **Confianza:** 0.0% `░░░░░░░░░░`
- **Fase:** viva

_... y 868955 aciertos más en los últimos 30 días_
...
*Ciclos totales: 5,124 · Sentinel Omega · Fractal Core Research*
