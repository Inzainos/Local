...
**Generado:** 2026-08-02 18:04 UTC (12:04 UTC-6)
...
| Hora de la medición | 2026-08-02 18:03 UTC | |
...
| Silent Trigger | inactivo | 76% ciclos | 75% ciclos | — | — |
...
| **92%** `▓▓▓▓▓` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 373 | ~8 días |
...
| alfa2 | _en vivo · 218 ciclos · 39641 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 1,530
...
| Aciertos / Fallos (vivos) | 155 / 1,530 | 155 / 1,508 | +0 aciertos |
| Pendientes de auditoría | 887 | 884 | +3 |
...
| **Total predicciones** | 869771 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178739/180269 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
*Ciclos totales: 2,580 · Sentinel Omega · Fractal Core Research*
