...
**Generado:** 2026-08-14 12:02 UTC (06:02 UTC-6)
...
| Hora de la medición | 2026-08-14 11:58 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.3, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.3 | 9.3 | 8.9 | 20.9 | P73 |
| Muro de los 5 | 3 | 2.7 | 2.3 | 4 | P100 |
| Silent Trigger | inactivo | 56% ciclos | 70% ciclos | — | — |
| Asertividad viva | 20% | 48% | — | — | — |
...
| alfa2 | _en vivo · 443 ciclos · 79668 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 20.2% |
...
- ACIERTO — avisó y el evento ocurrió: 882
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,447
...
| Asertividad viva | 20.2% | 20.3% | -0.1% |
| Aciertos / Fallos (vivos) | 882 / 3,447 | 880 / 3,425 | +2 aciertos |
| Pendientes de auditoría | 884 | 886 | -2 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 21% → 21% → 20% → 20% → 20%*
...
| **Total predicciones** | 872450 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179466/182913 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
_... y 868958 aciertos más en los últimos 30 días_
...
*Ciclos totales: 5,256 · Sentinel Omega · Fractal Core Research*
