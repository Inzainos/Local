...
**Generado:** 2026-08-12 08:12 UTC (02:12 UTC-6)
...
| Hora de la medición | 2026-08-12 08:12 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 9.9, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.9 | 8.6 | 8.8 | 20.9 | P69 |
| Muro de los 5 | 3 | 2.3 | 2.2 | 4 | P100 |
| Silent Trigger | inactivo | 72% ciclos | 71% ciclos | — | — |
| Asertividad viva | 21% | 55% | — | — | — |
...
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 23 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 74 | ~8 días |
...
| alfa2 | _en vivo · 392 ciclos · 70110 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 479
...
| Pendientes de auditoría | 479 | 460 | +19 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 20% → 21% → 21% → 21% → 21%*
...
*Ciclos totales: 4,635 · Sentinel Omega · Fractal Core Research*
