...
**Generado:** 2026-08-14 10:12 UTC (04:12 UTC-6)
...
| Hora de la medición | 2026-08-14 10:07 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 9.1, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.1 | 9.3 | 8.9 | 20.9 | P63 |
| Muro de los 5 | 3 | 2.7 | 2.3 | 4 | P100 |
| Silent Trigger | inactivo | 57% ciclos | 70% ciclos | — | — |
...
| alfa2 | _en vivo · 442 ciclos · 79480 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 20.3% |
| **Últimos 7 días** (viva) | 48.2% |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,425
...
| Asertividad viva | 20.3% | 20.4% | -0.1% |
| Aciertos / Fallos (vivos) | 880 / 3,425 | 880 / 3,400 | +0 aciertos |
| Pendientes de auditoría | 886 | 887 | -1 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 21% → 21% → 21% → 20% → 20%*
...
| **Total predicciones** | 872426 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 179464/182889 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 5,234 · Sentinel Omega · Fractal Core Research*
