...
**Generado:** 2026-08-29 08:53 UTC (02:53 UTC-6)
...
| Hora de la medición | 2026-08-29 08:50 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 15.5, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 15.5 | 8.2 | 8.5 | 20.9 | P99 |
| Muro de los 5 | 2 | 2.0 | 2.2 | 4 | P75 |
| Silent Trigger | inactivo | 81% ciclos | 74% ciclos | — | — |
| Asertividad viva | 22% | — | — | — | — |
...
| Niebla Tule (Anomalía) | 85% `▓▓▓▓░` | guerrero |
| Enjambre Sísmico Local | 95% `▓▓▓▓▓` | regional |
| Niebla Tule (Anomalía) | 85% `▓▓▓▓░` | guerrero |
| Enjambre Sísmico Local | 95% `▓▓▓▓▓` | regional |
...
| alfa2 | _en vivo · 634 ciclos · 114705 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| Asertividad viva | 21.9% | 21.7% | +0.3% |
| Aciertos / Fallos (vivos) | 1,252 / 4,398 | 1,091 / 3,895 | +161 aciertos |
| Pendientes de auditoría | 23,560 | 671 | +22889 |
| Pesos de bots | 6 bots | — | padre 1.00→0.30 |

*Asertividad viva, últimos cortes: 19% → 19% → 19% → 19% → 22%*
...
*Ciclos totales: 8,672 · Sentinel Omega · Fractal Core Research*
