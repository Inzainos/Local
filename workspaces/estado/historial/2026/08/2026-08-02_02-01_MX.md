...
**Generado:** 2026-08-02 08:01 UTC (02:01 UTC-6)
...
| Hora de la medición | 2026-08-02 07:59 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.0 | 7.9 | 8.8 | 16.8 | P2 |
| Muro de los 5 | 2 | 2.0 | 2.2 | 4 | P84 |
| Silent Trigger | activo | 78% ciclos | 77% ciclos | — | — |
...
| **89%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 373 | ~8 días |
...
| alfa2 | _en vivo · 207 ciclos · 37639 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 153
- FALLO — el evento ocurrió sin aviso (lo más castigado): 1,414
...
| Aciertos / Fallos (vivos) | 153 / 1,414 | 151 / 1,392 | +2 aciertos |
| Pendientes de auditoría | 884 | 887 | -3 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: — → 10% → 10% → 10% → 10%*
...
| **Total predicciones** | 869653 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178737/180151 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
_... y 868229 aciertos más en los últimos 30 días_
...
*Ciclos totales: 2,459 · Sentinel Omega · Fractal Core Research*
