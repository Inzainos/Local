...
**Generado:** 2026-09-08 23:11 UTC (17:11 UTC-6)
...
| Hora de la medición | 2026-09-08 23:07 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 14.7, muro 1/5 y firma máxima —.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 14.7 | 8.8 | 9.3 | 16.2 | P97 |
...
| Aciertos / Fallos (vivos) | 228 / 0 | 162 / 0 | +66 aciertos |
| Pendientes de auditoría | 225 | 315 | -90 |
| Pesos de bots | 9 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 80% → 80% → 80% → 80% → 67%*
...
| **Tasa de acierto** | 40.2% `▓▓▓▓▓░░░░░░░` |
| **Total predicciones** | 567 |
...
*Ciclos totales: 11,322 · Sentinel Omega · Fractal Core Research*
