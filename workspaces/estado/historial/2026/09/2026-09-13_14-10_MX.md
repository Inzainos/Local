...
**Generado:** 2026-09-13 20:10 UTC (14:10 UTC-6)
...
| Hora de la medición | 2026-09-13 20:07 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.5 | 10.3 | 10.4 | 16.2 | P18 |
| Muro de los 5 | 2 | 1.4 | 1.7 | 3 | P79 |
| Silent Trigger | activo | 38% ciclos | 44% ciclos | — | — |
| Asertividad viva | 96% | 96% | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 10647 |
| Ventanas con evento real (tasa base) | 1% |
| Asertividad del sistema | 96% |
| **Ganancia** (sistema ÷ tasa base) | 142.51× |
...
| **94%** `▓▓▓▓▓` | SISMO_M4 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 540 | ~8 días |
...
|---|---|---|---|
| alfa1 | 205 | 179,235 | 0.96 `▓▓▓▓░░` |
| beta1 | 899 | 179,235 | 1.00 `▓▓▓▓░░` |
| beta2 | 787 | 90,183 | 1.00 `▓▓▓▓░░` |
| delta | 675 | 64,123 | 1.00 `▓▓▓▓░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 4,330 | 179,235 | 1.00 `▓▓▓▓░░` |
| alfa2 | _en vivo · 869 ciclos · 155498 pases observados_ | — | 1.00 `▓▓▓▓░░` |
| jupiter | _en vivo · atención colectiva_ | — | 0.96 `▓▓▓▓░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 96.0% |
| **Viva** (operación real, auditada) | 96.4% |
| **Últimos 7 días** (viva) | 96.4% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 98.4% | 95.1% | 95.1% | 0.96 |
| alfa2 | 88.5% | 99.3% | 99.3% | 1.00 |
| beta1 | 96.7% | 92.9% | 92.9% | 1.00 |
| beta2 | 94.1% | 99.3% | 99.3% | 1.00 |
| delta | 99.7% | 99.3% | 99.3% | 1.00 |
| jupiter | 96.2% | 90.5% | 90.5% | 0.96 |
| loki | 98.7% | 99.3% | 99.3% | 1.00 |
| omega | 96.7% | 99.3% | 99.3% | 1.00 |
| padre | 95.8% | 92.2% | 92.2% | 1.00 |
...
- ACIERTO — avisó y el evento ocurrió: 10,261
- FALLO — el evento ocurrió sin aviso (lo más castigado): 72
- FALSO POSITIVO — avisó y no pasó nada: 314
...
| Asertividad viva | 96.4% | 96.4% | +0.0% |
| Aciertos / Fallos (vivos) | 10,261 / 72 | 10,261 / 72 | +0 aciertos |
| Pendientes de auditoría | 0 | 0 | +0 |
| Pesos de bots | 9 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 96% → 96% → 96% → 96% → 96%*
...
|-----|----------|------|-----------|----------------------|
| alfa2 | 1175/1183 | 99% `▓▓▓▓▓▓▓▓` | 0.00 | 0.1 |
| beta2 | 1175/1183 | 99% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| delta | 1175/1183 | 99% `▓▓▓▓▓▓▓▓` | 0.30 | 0.1 |
| loki | 1175/1183 | 99% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| omega | 1175/1183 | 99% `▓▓▓▓▓▓▓▓` | 0.40 | 0.1 |
| alfa1 | 1125/1183 | 95% `▓▓▓▓▓▓▓▓` | 0.31 | 0.1 |
| beta1 | 1099/1183 | 93% `▓▓▓▓▓▓▓░` | 0.30 | 0.1 |
| padre | 1091/1183 | 92% `▓▓▓▓▓▓▓░` | 0.19 | 0.1 |
| jupiter | 1071/1183 | 91% `▓▓▓▓▓▓▓░` | 0.22 | 0.1 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### LOKI — CALMA — (zonas monitoreadas)

- **Predicción:** 2026-09-11 00:44 UTC
- **Evento real:** 2026-09-11 08:02 UTC
...
#### ALFA1 — CALMA — (zonas monitoreadas)
...
#### PADRE — SISMO_M5 — (Baja California Sur)
...
- **Predicción:** 2026-09-11 00:39 UTC
- **Evento real:** 2026-09-11 08:02 UTC
- **Anticipación:** 0.1 días
- **Confianza:** 20.0% `▓▓░░░░░░░░`
- **Fase:** viva

_... y 10251 aciertos más en los últimos 30 días_
...
*Ciclos totales: 4,069 · Sentinel Omega · Fractal Core Research*
