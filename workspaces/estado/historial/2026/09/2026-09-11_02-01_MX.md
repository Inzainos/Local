...
**Generado:** 2026-09-11 08:01 UTC (02:01 UTC-6)
...
| Hora de la medición | 2026-09-11 07:57 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.0, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.0 | 10.8 | 10.5 | 16.2 | P58 |
| Muro de los 5 | 2 | 1.3 | 2.1 | 4 | P53 |
| Silent Trigger | activo | 34% ciclos | 45% ciclos | — | — |
...
|---|---|---|---|
| alfa1 | 205 | 179,235 | 0.92 `▓▓▓▓░░` |
| beta1 | 899 | 179,235 | 0.92 `▓▓▓▓░░` |
| beta2 | 787 | 90,183 | 0.86 `▓▓▓░░░` |
| delta | 675 | 64,123 | 0.86 `▓▓▓░░░` |
| omega | 360 | 179,235 | 0.92 `▓▓▓▓░░` |
| padre | 4,330 | 179,235 | 0.83 `▓▓▓░░░` |
| alfa2 | _en vivo · 827 ciclos · 148477 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 96.1% |
| **Últimos 7 días** (viva) | 96.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 98.4% | 94.9% | 94.9% | 0.92 |
| alfa2 | 88.3% | 99.3% | 99.3% | 1.00 |
| beta1 | 96.7% | 92.3% | 92.3% | 0.92 |
| beta2 | 94.1% | 99.3% | 99.3% | 0.86 |
| delta | 99.7% | 99.3% | 99.3% | 0.86 |
| jupiter | 96.2% | 90.0% | 90.0% | 1.00 |
| loki | 98.7% | 99.3% | 99.3% | 1.00 |
| omega | 96.6% | 99.3% | 99.3% | 0.92 |
| padre | 95.8% | 91.6% | 91.6% | 0.83 |
...
- ACIERTO — avisó y el evento ocurrió: 9,500
- FALLO — el evento ocurrió sin aviso (lo más castigado): 72
- FALSO POSITIVO — avisó y no pasó nada: 310
- PENDIENTE — ventana de 72h aún abierta: 765
...
| Asertividad viva | 96.1% | 0.0% | +96.1% |
| Aciertos / Fallos (vivos) | 9,500 / 72 | 0 / 0 | +9500 aciertos |
| Pendientes de auditoría | 765 | 0 | +765 |
| Pesos de bots | 9 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 0% → 96% → 0% → 96% → 0%*
...
| **Aciertos** | 9500 |
| **Fallos** | 72 |
| **Falsos positivos** | 310 |
| **Tasa de acierto** | 89.2% `▓▓▓▓▓▓▓▓▓▓▓░` |
...
|-----|----------|------|-----------|----------------------|
| alfa2 | 1090/1098 | 99% `▓▓▓▓▓▓▓▓` | 0.00 | 0.1 |
| beta2 | 1090/1098 | 99% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| delta | 1090/1098 | 99% `▓▓▓▓▓▓▓▓` | 0.30 | 0.1 |
| loki | 1090/1098 | 99% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| omega | 1090/1098 | 99% `▓▓▓▓▓▓▓▓` | 0.40 | 0.1 |
| alfa1 | 1042/1098 | 95% `▓▓▓▓▓▓▓▓` | 0.31 | 0.1 |
| beta1 | 1014/1098 | 92% `▓▓▓▓▓▓▓░` | 0.30 | 0.1 |
| padre | 1006/1098 | 92% `▓▓▓▓▓▓▓░` | 0.19 | 0.1 |
| jupiter | 988/1098 | 90% `▓▓▓▓▓▓▓░` | 0.22 | 0.1 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### LOKI — CALMA — (zonas monitoreadas)

- **Predicción:** 2026-09-10 21:06 UTC
- **Evento real:** 2026-09-10 23:06 UTC
...
_... y 9490 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,591 · Sentinel Omega · Fractal Core Research*
