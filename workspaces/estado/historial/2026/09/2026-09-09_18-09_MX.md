...
**Generado:** 2026-09-10 00:09 UTC (18:09 UTC-6)
...
| Precursores detectados | 2 | ["SEISMIC_CLUSTER", "PRECIPITACION"] |
| Hora de la medición | 2026-09-10 00:06 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.3, muro 1/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.3 | 10.8 | 9.4 | 16.2 | P53 |
| Muro de los 5 | 1 | 1.4 | 2.0 | 4 | P26 |
| Silent Trigger | inactivo | 40% ciclos | 59% ciclos | — | — |
| Asertividad viva | 93% | 93% | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 4500 |
| Ventanas con evento real (tasa base) | 0% |
| Asertividad del sistema | 93% |
...
| **94%** `▓▓▓▓▓` | SISMO_M4 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 133 | ~8 días |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 95.9% |
| **Viva** (operación real, auditada) | 93.1% |
| **Últimos 7 días** (viva) | 93.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 98.6% | 90.4% | 90.4% | 1.00 |
| alfa2 | 86.8% | 100.0% | 100.0% | 1.00 |
| beta1 | 96.7% | 84.8% | 84.8% | 1.00 |
| beta2 | 93.8% | 100.0% | 100.0% | 1.00 |
| delta | 99.9% | 100.0% | 100.0% | 1.00 |
| jupiter | 95.9% | 79.6% | 79.6% | 1.00 |
| loki | 100.0% | 100.0% | 100.0% | 1.00 |
| omega | 96.6% | 100.0% | 100.0% | 1.00 |
| padre | 95.7% | 83.2% | 83.2% | 1.00 |
...
- ACIERTO — avisó y el evento ocurrió: 4,190
- FALSO POSITIVO — avisó y no pasó nada: 310
- PENDIENTE — ventana de 72h aún abierta: 846
...
| Asertividad viva | 93.1% | 93.1% | +0.0% |
| Aciertos / Fallos (vivos) | 4,190 / 0 | 4,190 / 0 | +0 aciertos |
| Pendientes de auditoría | 846 | 837 | +9 |
...
| **Tasa de acierto** | 78.4% `▓▓▓▓▓▓▓▓▓░░░` |
| **Total predicciones** | 5346 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza | Anticipación (días) |
|-----|----------|------|-----------|----------------------|
| alfa2 | 500/500 | 100% `▓▓▓▓▓▓▓▓` | 0.00 | 0.1 |
| beta2 | 500/500 | 100% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| delta | 500/500 | 100% `▓▓▓▓▓▓▓▓` | 0.30 | 0.1 |
| loki | 500/500 | 100% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| omega | 500/500 | 100% `▓▓▓▓▓▓▓▓` | 0.39 | 0.1 |
| alfa1 | 452/500 | 90% `▓▓▓▓▓▓▓░` | 0.32 | 0.1 |
| beta1 | 424/500 | 85% `▓▓▓▓▓▓▓░` | 0.30 | 0.1 |
| padre | 416/500 | 83% `▓▓▓▓▓▓▓░` | 0.18 | 0.1 |
| jupiter | 398/500 | 80% `▓▓▓▓▓▓░░` | 0.24 | 0.1 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### LOKI — CALMA — (zonas monitoreadas)

- **Predicción:** 2026-09-09 20:11 UTC
- **Evento real:** 2026-09-09 22:12 UTC
...
_... y 4180 aciertos más en los últimos 30 días_
...
*Ciclos totales: 11,853 · Sentinel Omega · Fractal Core Research*
