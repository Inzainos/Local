...
**Generado:** 2026-09-01 15:00 UTC (09:00 UTC-6)
...
| Hora de la medición | 2026-09-01 14:58 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.1, muro 1/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.1 | 9.2 | 9.2 | 20.9 | P53 |
| Muro de los 5 | 1 | 1.7 | 2.1 | 4 | P16 |
| Silent Trigger | inactivo | 57% ciclos | 63% ciclos | — | — |
| Asertividad viva | 80% | 95% | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 29270 |
| Ventanas con evento real (tasa base) | 16% |
| Asertividad del sistema | 80% |
| **Ganancia** (sistema ÷ tasa base) | 4.94× |

**Veredicto:** ✅ GANANCIA REAL: el sistema aporta información

*Con 125 nodos UVG (75 reales + 50 Ghost) y radio de 5°, casi toda ventana de 72 h tiene un M4.5+ cerca de algún nodo: la dispersión global ya es nodal — para ganar más, las predicciones deben volverse específicas por nodo, no globales.*
...
| Niebla Tule (Anomalía) | 75% `▓▓▓▓░` | guerrero |
...
| **93%** `▓▓▓▓▓` | SISMO_M4 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 1,235 | ~8 días |
...
|---|---|---|---|
| alfa1 | 205 | 179,235 | 1.10 `▓▓▓▓░░` |
| beta1 | 899 | 179,235 | 1.00 `▓▓▓▓░░` |
| beta2 | 787 | 90,183 | 0.50 `▓▓░░░░` |
| delta | 675 | 64,123 | 1.50 `▓▓▓▓▓▓` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 4,330 | 179,235 | 0.73 `▓▓▓░░░` |
| alfa2 | _en vivo · 712 ciclos · 128847 pases observados_ | — | 1.00 `▓▓▓▓░░` |
| jupiter | _en vivo · atención colectiva_ | — | 1.00 `▓▓▓▓░░` |

## 🎯 Asertividad — ¿qué tan bien le ha ido?

> Tres formas de medir lo mismo. **Histórica**: al repasar los 32 años de datos como examen, ¿reconoció las vísperas de los eventos que ya sabemos que ocurrieron? **Viva**: desde que opera en tiempo real, cada aviso queda registrado y un auditor independiente (el Juez) lo califica 2 horas después contra los sismos que realmente ocurrieron — sin trampa posible. **7 días**: lo mismo, pero solo la última semana. La viva empieza en '—' hasta que las primeras ventanas de 2h se cierran.

| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 96.2% |
| **Viva** (operación real, auditada) | 80.0% |
| **Últimos 7 días** (viva) | 94.9% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 99.5% | 99.8% | 99.6% | 1.10 |
| alfa2 | 87.0% | 87.0% | 92.7% | 1.00 |
| beta1 | 97.3% | 93.6% | 94.5% | 1.00 |
| beta2 | 93.1% | 86.6% | 85.7% | 0.50 |
| delta | 99.9% | 100.0% | 100.0% | 1.50 |
| jupiter | 99.5% | 99.5% | 99.1% | 1.00 |
| omega | 96.0% | 93.6% | 94.5% | 1.00 |
| padre | 95.9% | 46.1% | 93.1% | 0.73 |
...
> El Juez es un auditor que **nunca predice**: solo registra cada aviso de los bots y, cuando se cierra la ventana de 2 horas, lo compara contra el catálogo sísmico real (USGS) y dicta sentencia. Dejar pasar un evento castiga 10 veces más que una falsa alarma — preferimos un sistema nervioso a uno dormido. **Solo la fase viva puntúa asertividad**; el resto es bitácora de entrenamiento y no se mezcla.

**Operación viva (lo que cuenta):**
- ACIERTO — avisó y el evento ocurrió: 23,426
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,398
- FALSO POSITIVO — avisó y no pasó nada: 1,446
...
| Asertividad viva | 80.0% | 80.0% | +0.0% |
| Aciertos / Fallos (vivos) | 23,426 / 4,398 | 23,426 / 4,398 | +0 aciertos |
| Pendientes de auditoría | 0 | 0 | +0 |
| Pesos de bots | 8 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 22% → 80% → 80% → 80% → 80%*
...
| **Aciertos** | 23187 |
| **Fallos** | 2102 |
| **Falsos positivos** | 1446 |
| **Tasa de acierto** | 86.7% `▓▓▓▓▓▓▓▓▓▓░░` |
| **Total predicciones** | 26735 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Total | Tasa | Confianza |
|-----|----------|-------|------|-----------|
| padre | 3747 | 6120 | 61.2% `▓▓▓▓▓░░░` | 0.05 |
| delta | 2945 | 2945 | 100.0% `▓▓▓▓▓▓▓▓` | 0.30 |
| alfa1 | 2939 | 2945 | 99.8% `▓▓▓▓▓▓▓▓` | 0.30 |
| jupiter | 2930 | 2945 | 99.5% `▓▓▓▓▓▓▓▓` | 0.20 |
| beta1 | 2757 | 2945 | 93.6% `▓▓▓▓▓▓▓░` | 0.33 |
| omega | 2757 | 2945 | 93.6% `▓▓▓▓▓▓▓░` | 0.27 |
| alfa2 | 2563 | 2945 | 87.0% `▓▓▓▓▓▓▓░` | 0.26 |
| beta2 | 2549 | 2945 | 86.6% `▓▓▓▓▓▓▓░` | 0.24 |

### 🎯 Predicciones y Aciertos Recientes

| Fecha | Bot | Señal | Nodo / Zona | Verdad Auditada (USGS) | Fase |
|-------|-----|-------|-------------|-------------------------|------|
| 2026-08-29 07:03 | `omega` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `jupiter` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `alfa2` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `delta` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `beta2` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `beta1` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `alfa1` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 07:03 | `padre` | **NO_SIGNAL** | Baja California Sur | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 06:56 | `omega` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |
| 2026-08-29 06:56 | `jupiter` | **NEUTRAL** | Nodo 14 | sin eventos en ventana de 2h (nodos de la predicción) | viva |

_... y 23177 aciertos más en los últimos 30 días_
...
*Ciclos totales: 10,503 · Sentinel Omega · Fractal Core Research*
