...
**Generado:** 2026-09-08 23:16 UTC (17:16 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **14.8** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-09-08 23:12 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 14.8, muro 1/5 y firma máxima —.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 14.8 | 8.9 | 9.3 | 16.2 | P98 |
| Muro de los 5 | 1 | 1.6 | 2.0 | 4 | P22 |
| Silent Trigger | inactivo | 61% ciclos | 62% ciclos | — | — |
...
- ACIERTO — avisó y el evento ocurrió: 228
- FALSO POSITIVO — avisó y no pasó nada: 114
- PENDIENTE — ventana de 72h aún abierta: 234
...
| Asertividad viva | 66.7% | 66.7% | +0.0% |
| Aciertos / Fallos (vivos) | 228 / 0 | 228 / 0 | +0 aciertos |
| Pendientes de auditoría | 234 | 225 | +9 |
| Pesos de bots | 9 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 80% → 80% → 80% → 67% → 67%*
...
| **Tasa de acierto** | 39.6% `▓▓▓▓▓░░░░░░░` |
| **Total predicciones** | 576 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza | Anticipación (días) |
|-----|----------|------|-----------|----------------------|
| alfa1 | 38/38 | 100% `▓▓▓▓▓▓▓▓` | 0.30 | 0.1 |
| alfa2 | 38/38 | 100% `▓▓▓▓▓▓▓▓` | 0.00 | 0.1 |
| beta2 | 38/38 | 100% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| delta | 38/38 | 100% `▓▓▓▓▓▓▓▓` | 0.30 | 0.1 |
| loki | 38/38 | 100% `▓▓▓▓▓▓▓▓` | 0.20 | 0.1 |
| omega | 38/38 | 100% `▓▓▓▓▓▓▓▓` | 0.36 | 0.1 |
| beta1 | 0/38 | 0% `░░░░░░░░` | 0.30 | 0.1 |
| jupiter | 0/38 | 0% `░░░░░░░░` | 0.31 | 0.1 |
| padre | 0/38 | 0% `░░░░░░░░` | 0.24 | 0.1 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### LOKI — CALMA — (zonas monitoreadas)

- **Predicción:** 2026-09-08 21:01 UTC
- **Evento real:** 2026-09-08 23:05 UTC
...
- **Predicción:** 2026-09-08 20:56 UTC
- **Evento real:** 2026-09-08 23:05 UTC
- **Anticipación:** 0.1 días
- **Confianza:** 20.0% `▓▓░░░░░░░░`
- **Fase:** viva
...
_... y 218 aciertos más en los últimos 30 días_
...
*Ciclos totales: 11,323 · Sentinel Omega · Fractal Core Research*
